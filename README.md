...
- Image upload by picker or drag-and-drop (JPG, PNG, WEBP; 100 MB file limit with automatic canvas downscaling for very large dimensions).
...
1. In GitHub Pages settings, select **GitHub Actions** as the build and deployment source.
2. Push to `main`; the supplied workflow runs linting, tests and the build, then deploys only `dist/`.
