...
/** Values suitable for the editor form; conversion to pixels happens during rendering. */
export function presetFormValues(p) { return { width: p.width, height: p.height, unit: p.unit, dpi: p.dpi }; }
